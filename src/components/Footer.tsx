  ...
  return (
    <>
      <div className="bg-gray-50 py-4">
        <div className="text-center w-full primary-font">
          <span
            onClick={openModal}
      ...
      <Modal isOpen={modalIsOpen} onRequestClose={closeModal}>
        <ModalContent className="">
          <div className="text-xl primary-font" style={{maxHeight: '500px'}}>
            ...
            предпринимаемые Аскаров Казбек (далее — Оператор). <br />
            ...
            https://github.com/tenshinoakumaa. <br />
            ...
            https://github.com/tenshinoakumaa.
            <br />
            ...
            права и обязанности Оператора <br />
            ...
            данных или другими федеральными законами. <br />
            ...
            иных прав, предусмотренных законодательством РФ. <br />
            ...
            год, месяц, дата и место рождения Правовые основания уставные
            (учредительные) документы Оператора договоры, заключаемые между
            оператором и субъектом персональных данных Виды обработки
            персональных данных Сбор, запись, систематизация, накопление,
            хранение, уничтожение и обезличивание персональных данных Отправка
            информационных писем на адрес электронной почты <br />
            ...
            федеральным законом. 8. Порядок сбора, хранения, передачи и других
            видов обработки персональных данных Безопасность персональных
            данных, которые обрабатываются Оператором, обеспечивается путем
            реализации правовых, организационных и технических мер, необходимых
            для выполнения в полном объеме требований действующего
            ...
            Оператора 220103035@stu.sdu.edu.kz с пометкой «Актуализация
            персональных данных». <br />
            ...
            220103035@stu.sdu.edu.kz с пометкой «Отзыв согласия на обработку
            персональных данных». <br />
            ...
            к Оператору с помощью электронной почты 220103035@stu.sdu.edu.kz.{" "}
            <br />
            ...
            сети Интернет по адресу https://github.com/tenshinoakumaa.
          </div>
        </ModalContent>
        <div className="text-center primary-font pt-2 text-xl font-bold primary-font">
          <button onClick={closeModal} className="rounded-xl bg-black text-white px-4 mt-2">Закрыть</button>
        </div>
      </Modal>
    </>
  );
